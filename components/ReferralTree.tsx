...
const TreeNode: React.FC<{ node: ReferralNode }> = ({ node }) => {
    ...
    const colors = [
        'border-neon-cyan bg-neon-cyan/20 text-white', // You (Root)
    ...
    return (
        <div className="flex flex-col items-center">
            <div className={cardClass}>
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-xs font-bold mb-1 border border-white/20">
                    {node.name.charAt(0)}
                </div>
